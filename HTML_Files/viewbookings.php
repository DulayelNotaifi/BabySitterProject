            ...
            <div class="finished">
                ...
                <?php if(date('Y-m-d') > $row['startDate'] ) { ?>
                    ...
                    while ($roww = $resultt->fetch_assoc()) {
                        if ($roww['cunt'] == 0) { ?>
                            <a href='../HTML_Files/review&rate.php?babySitterEmail=<?php echo($row['babySitterEmail'])?>&id_offer=<?php echo$row['id'];?> '>
                                <input type="submit" class="review" value="review"></a>                    <?php } ?>
